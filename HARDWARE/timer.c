...
void timer2_init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Period = 10000-1;//重装计数值
...
void timer3_init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Prescaler = 840-1;//840分频
	TIM_TimeBaseInitStructure.TIM_Period = 4000-1;//重装计数值
	TIM_TimeBaseInitStructure.TIM_CounterMode = TIM_CounterMode_Up;//向上计数
	TIM_TimeBaseInitStructure.TIM_ClockDivision = TIM_CKD_DIV1;//时钟分频
...
void timer9_init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Prescaler = 16800-1;//16800分频
	TIM_TimeBaseInitStructure.TIM_Period = 2000-1;//重装计数值
	TIM_TimeBaseInitStructure.TIM_CounterMode = TIM_CounterMode_Up;//向上计数
	TIM_TimeBaseInitStructure.TIM_ClockDivision = TIM_CKD_DIV1;//时钟分频
